...
VERIFICATION_BASE_URL = os.environ.get('VERIFY_URL', 'https://verify.docpilot.link')
...
def verify_email(event, context):
    ...
    try:
        ...
        redirect_base_url = os.environ.get("POST_VERIFY_REDIRECT_URL", "https://app.docpilot.com") # Nueva variable
        
        # Construir URL completa para la redirección
        redirect_url = f"{redirect_base_url}/login?verified=true&tenant={tenant_id}"
