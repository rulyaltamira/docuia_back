...
def send_verification_email(email, tenant_id, verification_token, temp_password):
    ...
    try:
        ...
        # Usar un remitente verificado (directamente de la lista de identidades verificadas)
        # Para pruebas usamos el email "ruly.altamirano@gmail.com" que está verificado
        sender_email = "ruly.altamirano@gmail.com"
...
def verify_email(event, context):
    ...
    try:
        ...
        users_table.update_item(
            Key={'user_id': user_id},
            UpdateExpression="SET status = :s, cognito_status = :cs, email_verified = :v",
            ExpressionAttributeValues={
                ':s': 'active',
                ':cs': 'activo',
                ':v': True
        ...
        redirect_url = 'https://app.docpilot.com/login?verified=true'
